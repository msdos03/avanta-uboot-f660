...
/* VERSIONS */
/************/
#define CONFIG_IDENT_STRING	" Marvell version: 2.1.6_NQ"
...
/************************/
	...
	#define CONFIG_JFFS2_PART_SIZE 0x01000000	/* sz of jffs2 part - 16 MB */

	#define CONFIG_JFFS2_NAND_OFF 0
	#define CONFIG_JFFS2_NAND_SIZE 16*1024*1024
	...
	/* Boot from NAND settings */
		...
		#define CONFIG_ENV_SIZE				0x4000		/* environment takes one erase block */
		#define CONFIG_ENV_OFFSET			0xC0000
		#define CONFIG_ENV_ADDR				CONFIG_ENV_OFFSET
		#define MONITOR_HEADER_LEN			0x200
		#define CONFIG_SYS_MONITOR_BASE			0
		#define CONFIG_SYS_MONITOR_LEN			CONFIG_ENV_OFFSET /* Reserve 768 kB for Monitor */
