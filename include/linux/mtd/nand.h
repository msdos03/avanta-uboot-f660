...
struct nand_chip {
	...
	int		(*block_bad)(struct mtd_info *mtd, uint64_t ofs, int getchip);
...
extern int nand_update_bbt(struct mtd_info *mtd, uint64_t offs);
extern int nand_default_bbt(struct mtd_info *mtd);
extern int nand_isbad_bbt(struct mtd_info *mtd, uint64_t offs, int allowbbt);
extern int nand_erase_nand(struct mtd_info *mtd, struct erase_info *instr,
			   int allowbbt);
extern int nand_do_read(struct mtd_info *mtd, uint64_t from, uint64_t len,
